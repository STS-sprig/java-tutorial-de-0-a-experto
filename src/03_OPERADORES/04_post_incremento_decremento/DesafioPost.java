...
Estás escribiendo un sistema de puntuación para un juego. El programa contiene múltiples
secuencias de operaciones usando incremento/decremento pre y post. Tu tarea es rastrear el
código y verificar tu comprensión.

    1. Comienza con estos valores iniciales:
        points = 5
        bonus = 10
        lives = 3
    2. Estudia estas secuencias y predice los resultados:

        result1 = points++; // Post-increment
        result2 = ++bonus;  // Pre-increment
        result3 = --lives;  // Pre-decrement
        result4 = lives--;  // Post-decrement
    3. Completa el código de verificación para comprobar si tus predicciones son correctas.
* */
